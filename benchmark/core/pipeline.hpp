...
// into the same component.  Returns one Group per connected component.
// This replaces the two-step find_overlapping_output_blocks + merge_groups
// pipeline with a single O(n log n) pass that never materialises the pairs.
