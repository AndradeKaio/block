...
def compile_gpu_dispatch(cuda_home: str, arch: str, bin_dir: Path) -> Path:
    ...
    srcs.append(str(_SCRIPT_DIR / "gpu_dispatch_demo.cu"))
...
def parse_args():
    ...
    g.add_argument("--bin-dir", default="",
                   help="directory for compiled gpu_dispatch_demo  (default: work-dir)")
...
def main():
    ...
    bin_dir = Path(args.bin_dir) if args.bin_dir else work_dir
